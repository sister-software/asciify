...
import { type Canvas2dContextLike, type CanvasLike, createCanvasLike } from "./canvas.ts"
...
/**
 * Reads the pixel buffer from a canvas element. This function is useful when you want to rasterize an existing canvas
 * to ASCII art.
 *
 * @category Helper
...
export function readFromCanvas(
	 ...
	 *
	 * Make sure to provide a canvas with the same dimensions as the asciify instance you're using.
	 *
...
/**
 * Reads the pixel buffer from an image element. This function is useful when you want to rasterize an image to ASCII
 * art.
 *
 * @category Helper
 * @see {@linkcode Asciify.rasterize}
...
export function readFromVideo(
	...
	/**
	 * A canvas to use for reading the video. You should provide this parameter if you'd like to cache the canvas.
	 *
	 * @optional
	 */
	canvas: CanvasLike = createCanvasLike()
	/**
	 * The 2D context to read from. You should provide this parameter if you'd like to cache the context, or provide a
	 * context optimized for your content.
	 */
) {
